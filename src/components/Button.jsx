export default function Button({ variant, children, onClick }) {
  ...
  const variants = {
    primary: 'bg-wa-green text-white hover:bg-wa-dark active:bg-wa-dark',
    secondary: 'bg-cream-surface text-gold-main border border-gold-main hover:bg-cream-alt active:bg-cream-alt',
  }
